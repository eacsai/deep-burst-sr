...
def compute_score(setting_name, load_saved=True):
    ...
    for n in network_list:
        ...
        out_dir = f'/home/qiwei/program/deep-burst-sr/indoor/DBSR_syn_{mode}'
        ...
        for idx in tqdm.tqdm(range(len(dataset))):
            ...
            for m, m_fn in metrics_all.items():
                net_pred = F.interpolate(net_pred, gt.shape[-2:], mode='bilinear', align_corners=False)
